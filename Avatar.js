function Avatar(nam, ag, user){
	...
	this.createAvatarWings = function(){
	
			var avatarWings = document.createElement("div");
			avatarWings.setAttribute("id", "avatarWings");			
			this.avatarSpace.appendChild(avatarWings);
		}	
	...
	this.executeAvatar = function(){
		...
		myAvatar.createAvatarWings(); /*render alas*/
